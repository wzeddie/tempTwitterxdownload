...
export const config = {
  matcher: [
    ...
    // - 静态文件
    // - sitemap文件
    '/((?!api|_next/static|_next/image|favicon.ico|ads.txt|robots.txt|manifest.json|sitemap.xml|sitemap_static.xml|.*\\.(?:png|jpg|jpeg|gif|webp|svg|ico|css|js|woff|woff2|ttf|eot)$).*)',
  ],
}; 